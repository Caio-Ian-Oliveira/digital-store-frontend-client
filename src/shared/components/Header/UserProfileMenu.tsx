  ...
  return (
    <>
      ...
      >
        ...
        {isMenuOpen && (
          <nav
            className="absolute right-0 top-12 w-56 bg-white rounded-lg shadow-[0_8px_24px_rgba(0,0,0,0.12)] border border-light-gray-3 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200"
            aria-label="Menu do usuário"
          >
            <header className="px-4 py-3 bg-[#FAFAFC]">
            ...
            <div className="border-t border-light-gray-3" aria-hidden="true" />
            ...
            <ul className="p-1 list-none">
              <li>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium text-[#C92071] rounded-md hover:bg-red-50 transition-colors text-left cursor-pointer"
                >
                  <LogOut size={16} />
                  Sair
                </button>
