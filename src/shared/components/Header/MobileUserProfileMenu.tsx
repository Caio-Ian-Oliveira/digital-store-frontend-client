        ...
        <DialogContent className="sm:max-w-106.25">
          ...
          <DialogFooter className="gap-2 sm:gap-0 mt-4">
            ...
            <button
              ...
              disabled={isLoggingOut}
              className="px-4 py-2 text-sm font-medium text-white bg-primary hover:brightness-90 rounded-md transition-colors flex items-center justify-center min-w-30 disabled:opacity-50"
            >
